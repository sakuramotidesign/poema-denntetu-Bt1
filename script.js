...
diceWrapper = document.getElementById("diceWrapper");
  ...
  // ② 状態を初期化
    myTeam = null;
      ...
      teams.A.phase = "SELECT_RELIEF";
      teams.B.phase = "SELECT_RELIEF";

      teams.A.relief = null;
      teams.B.relief = null;

      teams.A.reliefCount = { plus3: 0, double: 0 };
      teams.B.reliefCount = { plus3: 0, double: 0 };
